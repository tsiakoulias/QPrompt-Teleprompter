...
### [043-MEM-02] Memory Leak: `_fileSystemWatcher` allocated without parent, never deleted
...
### [145-MEM-03] Memory Leak: `m_fontDialog` allocated without parent, never deleted
...
### [142-LOG-05] DocumentHandler::search ignores `loop` parameter when `regEx` is true
...
### [691-LOG-09] Trailing comma in constructor member initializer list (non-standard C++ before C++20)
...
### [618-QML-09] `QtQuick.Shapes 6.6` version mismatch with `QtCore 6.5`
...
### [184-SEC-02] OBS WebSocket Password Stored in Plaintext
...
### [529-SEC-04] SSRF / URL Injection — User-Controlled URL Passed to Network Loader
...
### [600-SEC-05] User-Controlled Filename Passed to QProcess (LibreOffice import)
...
### [061-RES-01] Network reply overwritten without aborting previous download
...
### [700-RES-05] QTextStream left unflushed before QFile destruction
...
### [532-TYP-01] Dangling pointer from temporary std::string in SpellChecker::loadOne
...
### [267-TYP-04] Bitwise AND on bools hides dead code in preventSleep
...
### [268-TYP-05] Uninitialized pointer member m_reply in DocumentHandler
...
### [027-EDGE-01] QString::arg() called on string with no placeholder — program name silently dropped
...
### [003-EDGE-05] Null pointer dereference: `textDocument()` unchecked in `search()`
...
### [554-EDGE-11] m_reply dereference without null check in loadFromNetworkFinihed()
...
### [087-PLAT-01] KF6Crash_FOUND never defined as C preprocessor macro — KCrash support dead code
...
### [612-PLAT-04] DS_Store.scpt referenced but file does not exist
...
### [234-PLAT-05] DBINARY_ICONS_RESOURCE is a typo — should be BINARY_ICONS_RESOURCE
...
### [431-PLAT-07] Incorrect macro syntax: `#define Use_GlobalAccel = 1`
- **File:** src/globalhotkeys.cpp:29
- **Severity:** Low
- **Code:**
  ```cpp
...
### [498-R2-CMAKE-01] sphinx_add_docs silently ignores all keyword arguments due to empty cmake_parse_arguments prefix
...
### [240-R2-CMAKE-03] WORKING_DIRECTORY and COMMENT not parseable by callers of sphinx_add_docs
...
### [243-R2-PRP-02] Kirigami.Units.SmallSpacing — uppercase S yields undefined
...
### [593-R2-PTR-01] Type mismatch: textVerticalOffset declared int but fed a real
...
### [245-R2-PTR-04] Inverted indexOf truthiness in platform check for ColorDialog
...
### [463-R2-AND-04] Android Settings for "background" missing transparency persistence
...
### [410-R2-OVL-02] LanguageSettingsOverlay popup ListView currentIndex always resolves to -1
...
### [165-R2-PTH-01] FileDialog filter matches all files on Linux due to stray glob
...
### [166-R2-PTH-02] File path from file:// URL preserves percent-encoding
...
### [072-R2-EDT-02] wheelThrottleSettingsButton checked bound to completely unrelated document property
...
### [246-R2-TEL-01] Telemetry sub-toggles permanently disconnect from master toggle on click
...
### [163-R2-FONT-01] RichText label renders unescaped plain text — HTML metacharacters break display
...
### [161-R2-ANDMAN-01] Ungrantable system/signature permissions bloating manifest
...
### [055-R3-DOC-07] Inverted selection state after failed search()
...
### [251-R3-SPL-02] decode() uses fromLocal8Bit() — suggestions show as mojibake
...
### [171-R3-SPL-04] Corrupt cached dictionary file persists permanently after failed copy
...
### [089-R3-MAIN-02] Invalid locale string constructed for short language codes
...
### [699-R3-MAIN-04] Stack-allocated QTranslator outlives QApplication on shutdown
...
### [169-R3-MAIN-07] XDG_CURRENT_DESKTOP unconditionally forced to "KDE" on all Linux
...
### [692-R3-APP-01] AppController singleton and children never deallocated
...
### [370-R3-SIG-01] textChanged() signal declared but never emitted
...
### [571-R3-PMT-03] goToNextMarker fallback desynchronizes cursor from viewport
...
### [573-R3-TMR-01] TimerClock ETA uses __iDefault instead of actual __i during reverse scroll
...
### [505-R4-QTV-01] QtQuick 2.13 import does not exist in Qt 6.5
...
### [466-R4-EXP-09] LibreOffice import --cat and --convert-to flags are contradictory
...
### [508-R4-EVT-01] Missing braces on if/else — syntax error in alignRightButton
...
### [177-R4-PRJ-04] Division by zero in projection image height
...
### [254-R4-ROV-03] Bitwise OR | used for width fallback instead of logical OR
...
### [252-R4-BKG-01] Flip transform origin stays at (0,0) when Flip stored as property
...
### [501-FINAL-02] Missing `QtQuick.Controls.Material` import — 3 Material references unresolved
...
### [519-FINAL-10] Two animations target same `position` property — conflict
...
### [213-FINAL-19] Encoding fallback uses toLocal8Bit() instead of dictionary's actual encoding
...
### [022-CUR-N02] search() regex path ignores loop parameter — unconditional wrap
...
### [503-IMP-N02] import QtWebSockets 1.10 — wrong version for Qt 6.5
...
### [041-MATH-N01] Division by zero in __timeToArival/__timeToEnd when speed=0
...
### [068-LYR-N01] InputsOverlay calls cursorAutoHide.restart() on open instead of reset()
- **File:** src/kirigami_ui/InputsOverlay.qml:41
- **Severity:** High
- **Category:** Logic
...
### [304-LYR-N02] Three OverlaySheets missing from ESC dismiss chain
...
### [224-LYR-N04] ESC handler uses activeFocus in base but focus in platform variants — inconsistent
...
### [354-W10-PMV-02] Circular ShaderEffectSource dependency — shadow ghost on first frame
...
### [102-W10-CNV2-03] import() uses fromStdString on non-Windows — encoding corruption
...
### [096-W10-SWT-01] CloseActions switch drops RecentLocal/RecentRemote — recent document open silently lost after save
...
### [016-W10-DEP-01] Missing vcpkg.json manifest — vcpkg manifest mode installs nothing
...
### [492-TS-05] Finnish/French/Korean/Italian "Saved" → verb with stray `&amp;` accelerator
- **Files:** po/qprompt_fi.ts:678, po/qprompt_ko.ts:677, po/qprompt_it.ts:679

### [707-TS-06] Czech/French "Language settings" → "Pointer settings" (copy-paste error)
...
### [716-TS-15] Finnish/Korean right pointer reuse → left pointer (swapped)
- **Files:** po/qprompt_fi.ts:494, po/qprompt_ko.ts:493

### [493-TS-16] Paragraph spacing: 8 languages strip trailing `%` from `<pre>%1%</pre>`
...
### [558-HTK-05] VelocityTo0 default shortcut uses `Qt::Key_acute` — unreachable dead key
...
### [559-HTK-06] Pause (Ctrl+Space) and Stop (Meta+Space) conflict — Meta+Space captured by OS
...
### [189-SPL2-11] addCustomWord trims but removeCustomWord does not — asymmetry
...
### [190-SPL2-12] Case-sensitive contains/indexOf but case-insensitive sort — duplicates
...
### [378-SPL2-19] availableDictionaries enumerates .dic without verifying .aff exists
...
### [108-BLD-05] .env.android references Qt 5.15.2 — project requires Qt 6.8.2+
- **File:** .env.android:6
- **Severity:** Medium
...
### [082-EVT-04] Drag breaks editor.x declarative binding permanently
...
### [083-EVT-05] Drag breaks positionHandler.x declarative binding permanently
...
### [126-EVT-07] TabBar currentIndex binding broken on first TabButton click
...
### [127-EVT-08] Two additional checkable ToolButton binding breakage instances
...
### [044-NET-01] loadFromNetworkFinihed never checks m_reply->error()
...
### [602-THR-01] IosSaveDialog::create() — unsynchronized singleton race
...
### [343-DRW-01] interalFocusElsewhere() misses 3 OverlaySheets + 2 Drawers — hotkeys pass through
...
### [344-DRW-02] globalDrawer and contextDrawer missing from ESC dismiss chain
...
### [340-AND-MFT-01] FileProvider resource @xml/qtprovider_paths — file named filepaths.xml
...
### [423-FOC-N03] Tab/Backtab asymmetry — Backtab silently unhandled
...
### [368-QCN-01] O(n²) contains()-in-loop during custom words file load
...
### [231-OPC-01] Right-click toggle desynchronizes velocityIndicator visible/opacity
...
### [401-HDR-N01] promptsession.h not in CMakeLists.txt — SessionModel/DataPoint dead code
...
### [648-CMAKE-N01] WASM build excludes TelemetryPage.qml and RemotePage.qml
...
### [229-OOB-N01] MarkersModel::data() — m_data.at() without row < rowCount() guard
...
### [230-OOB-N02] SessionModel::data() — same missing row bounds guard
...
### [668-OOB-N03] alignment() fetches textCursor() twice — stale cursor race
...
### [063-STR-N01] main.cpp:158 QLatin1String iterator-pair UB from two unrelated string literals
- **File:** main.cpp:158
- **Severity:** High
...
### [211-ENUM-01] documenthandler.cpp:1108 updateContents switch no default — silent data loss
...
### [295-GEO-02] main.qml persists x/y/width/height with zero validation
...
### [625-AR-01] PrompterView.qml:53-58 Rotation debug feature clips on extreme aspect ratios
...
### [316-SAFE-01] +android/main.qml zero safe area insets
- **File:** +android/main.qml
- **Severity:** Medium
...
### [317-SAFE-02] ReadRegionOverlay screenMiddle ignores notch/status bar height
...
### [530-SET-01] macOS/iOS: QSettings split across two preference domains
...
### [639-SET-03] QString "true" used as default for boolean QSettings value
...
### [395-DLG-N03] errorDialog MessageDialog has no title
...
### [698-IMP-NEW-02] main.cpp:22 #include "qglobal.h" uses quotes + Qt5-era name
- **File:** main.cpp:22
- **Severity:** Low
...
### [686-IMP-NEW-04] AboutPage.qml imports Kirigami 2.9 vs 2.11 in all other files
...
### [363-MA-N02] textDragArea missing cursorShape — ArrowCursor over IBeamCursor on editor
...
### [539-CMT-N05] Missing security warning on QProcess RCE sink (sys://)
...
### [610-CMT-N09] Commented-out PropertyActions in active loop animation — stale state risk
...
### [626-CMT-N10] Obsolete Qt 5 qmlRegisterType calls as commented-out cruft
...
### [548-REGEX-N01] All 13 QRegularExpression objects lack isValid() checks
...
### [180-REGEX-N02] regex_5 accidentally excludes 15+ HTML5 tags from background-color filtering
...
### [136-HK-N02] Typo Qt.Key_VolumeDowm — "Dowm" instead of "Down" — volume-down hardware key dead
...
### [100-HK-N03] platformName() != "wayland" fails on "wayland-egl" — global hotkeys dead
...
### [045-PROP-N01] on__FullScreenChanged handler casing mismatch — never fires
- **File:** main.qml:36-37
- **Severity:** High
...
### [408-NET-N06] loadFromNetwork() validates original URL, not constructed resultingUrl
...
### [487-VIS-N04] Countdown crosshair frame renders orphan lines when enabled=false
...
### [615-SCRL-N01] __jitterMargin: fractional result from modulus violates 0/1 toggle design
...
### [384-TYP-N01] Misspelled method name: loadFromNetworkFinihed (missing 's')
...
### [682-TYP-N06] 9 getters copy-paste double-textCursor() pattern — null check on stale cursor
...
### [584-IMG-N01] Missing go-previous-symbolic.svg — back-navigation icon blank on Android/Windows
...
### [581-ACT-N05] +windows main.qml Controls Settings submenu missing OBS Settings action
...
### [199-ACT-N07] namedBookmarkButton: checkable button opens dialog — stale indicator after first click
...
### [257-RENDER-02] ShaderEffectSource pointerShadowSource runs unconditionally — same pattern
...
### [567-PLAT-N01] qmlutil.hpp incorrectly excludes QNX from QProcess — run()/restartApplication() silently no-op
...
### [536-PLAT-N03] Zero Q_OS_TVOS preprocessor guards in C++ despite 19 QML references — build failure
...
### [619-DECL-N01] MarkersModel::keySearch — default params in definition but not declaration
...
### [479-COLOR-03] velocityText ColorAnimation flash: #BBB → #FFF → #CCC jump
...
### [652-COLOR-06] Countdown #FFF digits on #333-at-0.48-overlay — insufficient contrast on light backgrounds
...
### [262-STATE-N02] Find.toggle() uses !visible instead of !isOpen — can't close during Prompting
- **File:** Find.qml:51
- **Severity:** Medium
...
### [641-STATE-N04] loop animation cancel() state change overridden by toggle() due to QML batching
...
### [653-CONST-N01] getMarkerKey() not const — pure reader without side effects
...
### [259-SAVE-N01] loadFromNetworkFinihed sets m_fileUrl to phantom QTemporaryFile path
...
### [076-SAVE-N02] iOS save flow never updates C++ m_fileUrl — file URL perpetually stale
...
### [373-SAVE-N05] save() broken on Android content:// URIs — empty filename
...
### [220-LOAD-N01] TOCTOU race between QFile::exists() and file.open() in load()
- **File:** documenthandler.cpp:944-947
- **Severity:** Medium
...
### [187-SHDR-N01] Math.cos/Math.sin used with degrees value — shadow offset diagonal instead of horizontal
...
### [547-RAII-N01] QDrag object never deleteLater'd after exec() — leaks on rejected drags
...
### [684-Z-N04] PrompterBackground (z:0) renders above viewport.mouse (z:0) — latent input intercept
...
### [200-API-N01] setAlignment() missing null-cursor guard — crash risk with no document
...
### [419-API-N04] setMarker(bool) misleadingly named — sets regular marker, not any marker
...
### [388-API-N05] fileName()/fileType() return fabricated defaults — can't distinguish "no file" from "untitled.html"
...
### [721-ARC-05] Prompter.qml is 3139-line god component spanning velocity, state machine, keyboard, WebSocket, markers, spellcheck UI, file dialogs, WYSIWYG toggle, shadows
...
### [260-SCALE-N01] Right pointer xScale: -1 mirrors text pointers — backwards/unreadable text
...
### [452-BIND-N01] contentWidth undefined for Shape/Image pointer types — transform origin silently wrong
...
### [357-COMP-N01] Case-sensitive duplicate detection in setLanguages()
...
### [116-COMP-N02] Case-sensitive suffix check misses mixed-case extensions — silent format loss
...
### [562-LBL-N01] All 12 Sliders in EditorToolbar missing Layout.fillWidth: true — cramped
...
### [154-PATH-N02] reload() constructs file:// URL via raw string concat — #/? in filenames break URL
- **File:** documenthandler.cpp:860
- **Severity:** Medium
...
### [226-MENU-N02] Mobile "Add to dictionary" missing %1 placeholder — word never shown
...
### [305-MENU-N03] Text alignment menu RTL swap: labels swap but actions don't
...
### [406-MENU-N04] Trailing empty MenuSeparator at end of mobile context menu
...
### [206-DBG-N01] OBS WebSocket auth challenge+salt logged to console in release builds
...
### [393-DBG-N02] Velocity debug logging active in production
...
### [489-DBG-N03] Latent debug state leak: pointers/debug Setting persists Guides checkbox
...
### [647-WARN-N03] quint64→int implicit narrowing in nextMarker()/previousMarker()
...
### [416-WARN-N04] QProcess::startDetached() bool return silently ignored
- **File:** qmlutil.hpp:91
- **Severity:** Low
...
### [556-FLOW-N02] increaseVelocity()/decreaseVelocity() skip velocity change when paused
...
### [332-TXT-N04] goToNextMarker() temporarily sets cursorPosition=-1 — corrupts cursor state
...
### [635-INT-N03] 6 qsizetype→int narrowing conversions across models and loops
...
### [272-URL-N03] Network-loaded HTML lacks base URL — relative resources broken
...
### [414-URL-N04] loadFromNetwork() validates wrong URL instance
- **File:** documenthandler.cpp:881
- **Severity:** Low
...
### [273-URL-N05] openFromRemote() blindly prepends http:// to non-HTTP schemes
...
### [527-REGEX-CRIT-01] regex_4 destroys <body> tag — removes opening tag instead of color attributes
...
### [181-REGEX-N06] imgSrcRegex captures wrong src when data-src follows real src
...
### [645-VCI-N01] At-end action buttons use inconsistent font scaling (1/1.5 vs 1/1.75) in same group
...
### [646-VCI-N02] upperControls and bottomControls fade to different opacity levels during Prompting
...
### [080-AND-HIGH-01] Android back button doesn't dismiss overlays/drawers before close
...
### [585-IMH-SYS] Systemic absence of inputMethodHints on ALL TextFields (16 sites)
...
### [557-FONT-N01] font.family: "Monospace" never resolves — no such font on any OS
...
### [648-CMAKE-N01] QML_IMPORT_PATH set twice — KIRIGAMI_DIRS lost
...
### [356-CMAKE-N05] Android not excluded from KDE module includes and desktop install rules
...
### [576-SETUP-N01] setup.sh uses windeployqt.exe (Qt 5) — should be windeployqt6.exe (Qt 6)
- **File:** setup.sh:233
- **Severity:** Medium
...
### [261-ST-N02] Dead overlay.state PropertyChanges — overlay has no states array
...
### [420-CFG-N02] v1.1.3 release date "2022-1-16" breaks chronological order — should be 2023-01-16
...
### [331-TP-N01] "Error loading file..." used as document content, not placeholderText
...
### [417-WATCH-N04] unblockFileWatcher() dereferences _fileSystemWatcher without null guard
...
### [513-COERC-N01] parseInt("") → NaN state bootstrap — first toggle() bricks state machine
...
### [421-COERC-N03] real→int truncation in WindowDragger position compounds drift
...
### [705-SYM-N01] 6 RTL/symmetry issues across PointerSettings, Find, PrompterView, Prompter, PrompterPage
...
### [214-INT-N04] OBS URL/Password fields disabled when WebSocket enabled — inverted logic
...
### [197-WYS-N01] Internal drag-and-drop copy inserts HTML as plain text — tags become visible
...
### [070-QP-N01] restartApplication() quits even when startDetached fails — app dies with no replacement
...
### [584-IMG-N01] insertImageAt() has no data: URI handler — silently drops data URI images
...
### [033-IMG-N02] insertHtmlAt() silent blocking HTTP load for img src URLs — UI freeze
...
### [518-EVT-N13] rewind()/fastForward() event undefined — winding state permanently locked after first use
...
### [279-ANM-N02] Standby→Ready countdown opacity flash — PropertyChanges opacity:1 conflicts with dissolveIn
...
### [674-RESO-N03] Control spacing hardcoded 8dp — cramped on large displays
...
### [469-RESO-N06] ReadRegionOverlay pointer margin 3dp — overlap with text at large fonts
...
### [300-JS-N02] markerCompare() per-frame JSON.stringify() over OBS marker — 60 allocs/sec
...
### [093-THM-SYS] Complete theme deadlock — 50+ Material.theme: Dark hardcoded, theme toggle commented out
- **Files:** 14 QML files
- **Severity:** High
...
### [289-COLOR-N09] acceptedColor binds transparent QColor on startup — initial text invisible
- **File:** PrompterPage.qml:1010,1025, PrompterView.qml:240-241
- **Severity:** Medium
...
### [264-TMR-N06] Auto-reload Timer persists after network dialog close — background refetches
...
### [294-FONT-METRIC-02] FontLoader status never checked — font substitution silently fails
...
### [601-STC-N03] velocityIndicator.firstResetDone never cleared on dismiss — second activation broken
...
### [574-RESP-N02] mobileOrSmallScreen threshold at 1231px activates on default 1220px launch
- **File:** main.qml:54,77
- **Severity:** Medium
...
### [476-TC-N02] property color value assigned string expression — silent coercion
...
### [203-BLK-N03] setLineHeight/setParagraphHeight apply document-wide — destroy per-block customization
...
### [302-LL-N01] 10 EditorToolbar MouseArea/TextField width-depends-on-width binding loops
...
### [186-SHAPE-N01] pointer_0.qml PathLine parent.width resolves to undefined (ShapePath has no width) — arrow collapsed
...
### [577-SHAPE-N02] concentricCircles Shape uses parent-space coordinates in local space — circles off-center
...
### [542-MIME-N01] Temporary QMimeDatabase — QMimeType dangling on Qt 5 (undefined behavior)
...
### [266-TXT-FMT-N01] setMarkerHref("") fails to clear QTextFormat::AnchorHref — stale href persists
